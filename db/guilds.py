    ...
    with db.transaction() as cur:
        ...
        for ch in channels:
            cur.execute(
                ...
                "(guild_id, channel_id, channel_name, channel_type) VALUES(?, ?, ?, ?)",
                (ch.guild_id, ch.channel_id, ch.channel_name, ch.channel_type),
            )
